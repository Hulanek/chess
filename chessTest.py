...
simple_model_history = evalModel.fit(input_bitboards, evals, batch_size=100, epochs=30, validation_data=(test_input_bitboards, test_evals))

evalModel.save('ULTIAMTEMODEL3000.keras')
